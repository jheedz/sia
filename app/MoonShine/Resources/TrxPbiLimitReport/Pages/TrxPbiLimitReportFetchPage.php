...
/**
 * @extends FormPage<TrxPbiLimitReportResource>
 */
class TrxPbiLimitReportFetchPage extends FormPage
{
    public function getTitle(): string
    {
        return 'Fetch Data TrxPBI Limit dari Elasticsearch';
    }
    ...
    protected function mainLayer(): array
    {
        ...
        return [
            Heading::make('Fetch Data TrxPBI Limit dari Elasticsearch'),
            ...
            Alert::make(type: 'info')
                ->content('⏳ Data diambil dari index <strong>wic-trx-pbi-ceklimit*</strong> field <strong>RequestTime</strong> (UTC, dikonversi ke WIB +07:00). Data dikelompokkan per jam per mata uang.'),
                    ...
                    ->fields([
                        Flex::make([
                            ...
                            ActionButton::make()
                                ...
                                ->dispatchEvent([
                                    AlpineJs::event(JsEvent::FORM_SUBMIT, 'trx-pbi-limit-fetch-form'),
                                ]),
                        ])->unwrap(),
                    ])
                    ->hideSubmit(),
    ...
    public function fetchManual(): JsonResponse
    {
        ...
        try {
            $service = app(TrxPbiLimitReportService::class);
            $success = 0;
            $failed  = 0;
            $current = $from->copy();
